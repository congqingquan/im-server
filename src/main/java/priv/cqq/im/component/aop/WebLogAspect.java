package priv.cqq.im.component.aop;
...
import priv.cqq.im.util.JWSUserUtils;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(* priv.cqq.im.controller..*Controller.*(..))")
    private void log() {
    }
    ...
    public Object logAround(ProceedingJoinPoint point) throws Throwable {
        ...
        setTrackId();
        // 2) 登录用户
        IMUser currentSysUser = JWSUserUtils.getSysUser();
        // 3) 方法形参
        ...
        log.info("用户 [{}] IP [{}] 进入 [{}.{}] 方法 {} 入参:{} {}",
                currentSysUser == null ? "No user info" : currentSysUser.getUsername(), requestIp, className, methodName,
            getLineSeparator(2),
            requestParamMap,
            getLineSeparator(1));
        ...
        try {
            ...
            log.info("用户 [{}] IP [{}] 结束 [{}.{}] 方法调用 耗时 {}ms {} 出参{} {}",
                    currentSysUser == null ? "No user info" : currentSysUser.getUsername(),
